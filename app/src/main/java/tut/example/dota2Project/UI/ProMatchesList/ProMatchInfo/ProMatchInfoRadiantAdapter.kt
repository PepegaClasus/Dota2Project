package tut.example.dota2Project.UI.ProMatchesList
...
import tut.example.dota2Project.UI.ProMatchesList.ProMatchInfo.ProMatchInfo

class ProMatchInfoRadiantAdapter(val list: List<MatchPlayerModel>, val fragment: ProMatchInfo) :
    RecyclerView.Adapter<ProMatchInfoRadiantAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ProMatchInfoRadiantAdapter.ViewHolder {
        ...
        holder.itemView.setOnClickListener {
            fragment.showRadiantInfo(holder.adapterPosition)
        }
    ...
    override fun onBindViewHolder(holder: ProMatchInfoRadiantAdapter.ViewHolder, position: Int) {
...
class ProMatchInfoDireAdapter(val list: List<MatchPlayerModel>, val fragment: ProMatchInfo) :
    RecyclerView.Adapter<ProMatchInfoDireAdapter.ViewHolder>() {
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ProMatchInfoDireAdapter.ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val itemView = inflater.inflate(R.layout.player_match_info_item, parent, false)
        val holder = ViewHolder(itemView)
        ...
        holder.itemView.setOnClickListener {
            fragment.showDireInfo(holder.adapterPosition)
        }
    ...
    override fun onBindViewHolder(holder: ProMatchInfoDireAdapter.ViewHolder, position: Int) {
        val players: MatchPlayerModel = list[position]
