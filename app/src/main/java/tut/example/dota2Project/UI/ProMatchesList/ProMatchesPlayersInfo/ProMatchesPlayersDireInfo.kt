...
import tut.example.dota2Project.databinding.FragmentProMatchesPlayersDireInfoBinding

class ProMatchesPlayersDireInfo : Fragment() {
    lateinit var navController: NavController
    val viewModel: DotaViewModel by activityViewModels()
    private lateinit var binding: FragmentProMatchesPlayersDireInfoBinding
    val scope = MainScope()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pro_matches_players_dire_info, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        navController = view.findNavController()
        binding = FragmentProMatchesPlayersDireInfoBinding.bind(view)
    ...
    fun tuta() {
        scope.launch {
            ...
            val finalDamage1 = damage?.get(5)
            val finalDamage2 = damage?.get(6)
            val finalDamage3 = damage?.get(7)
            val finalDamage4 = damage?.get(8)
            val finalDamage5 = damage?.get(9)
            ...
            val damageTaken1 = damageTaken?.get(5)
            val damageTaken2 = damageTaken?.get(6)
            val damageTaken3 = damageTaken?.get(7)
            val damageTaken4 = damageTaken?.get(8)
            val damageTaken5 = damageTaken?.get(9)
            ...
            val healing1 = healing?.get(5)
            val healing2 = healing?.get(6)
            val healing3 = healing?.get(7)
            val healing4 = healing?.get(8)
            val healing5 = healing?.get(9)
            ...
            val lastHits1 = lastHits?.get(5)
            val lastHits2 = lastHits?.get(6)
            val lastHits3 = lastHits?.get(7)
            val lastHits4 = lastHits?.get(8)
            val lastHits5 = lastHits?.get(9)
            ...
            val denies1 = denies?.get(5)
            val denies2 = denies?.get(6)
            val denies3 = denies?.get(7)
            val denies4 = denies?.get(8)
            val denies5 = denies?.get(9)
            ...
            val netWorth1 = netWorth?.get(5)
            val netWorth2 = netWorth?.get(6)
            val netWorth3 = netWorth?.get(7)
            val netWorth4 = netWorth?.get(8)
            val netWorth5 = netWorth?.get(9)
            ...
            val goldPerMinute1 = goldPerMinute?.get(5)
            val goldPerMinute2 = goldPerMinute?.get(6)
            val goldPerMinute3 = goldPerMinute?.get(7)
            val goldPerMinute4 = goldPerMinute?.get(8)
            val goldPerMinute5 = goldPerMinute?.get(9)
            ...
            val goldSpent1 = spendGold?.get(5)
            val goldSpent2 = spendGold?.get(6)
            val goldSpent3 = spendGold?.get(7)
            val goldSpent4 = spendGold?.get(8)
            val goldSpent5 = spendGold?.get(9)
            ...
            val obsPlaced1 = obsUsed?.get(5)
            val obsPlaced2 = obsUsed?.get(6)
            val obsPlaced3 = obsUsed?.get(7)
            val obsPlaced4 = obsUsed?.get(8)
            val obsPlaced5 = obsUsed?.get(9)
            ...
            val obsDestroy1 = obsDestroyed?.get(5)
            val obsDestroy2 = obsDestroyed?.get(6)
            val obsDestroy3 = obsDestroyed?.get(7)
            val obsDestroy4 = obsDestroyed?.get(8)
            val obsDestroy5 = obsDestroyed?.get(9)
            ...
            val sentryPlaced1 = sentryPlaced?.get(5)
            val sentryPlaced2 = sentryPlaced?.get(6)
            val sentryPlaced3 = sentryPlaced?.get(7)
            val sentryPlaced4 = sentryPlaced?.get(8)
            val sentryPlaced5 = sentryPlaced?.get(9)
            ...
            val sentryKills1 = senKil?.get(5)
            val sentryKills2 = senKil?.get(6)
            val sentryKills3 = senKil?.get(7)
            val sentryKills4 = senKil?.get(8)
            val sentryKills5 = senKil?.get(9)
